...
fn vrt_aa_insert_primitive(rbtv : void*, key : ulong, value : void*) void;
fn vrt_aa_insert_array(rbtv : void*, key : void[], value : void*) void;
...
fn vrt_aa_rehash(rbtv : void*) void;
